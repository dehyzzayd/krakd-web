...
export default async function FinancingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      <section className="w-full text-white" style={{ background: `linear-gradient(120deg, ${accent} 0%, #0f172a 100%)` }}>
        <div className="mx-auto max-w-[1280px] px-5 py-16">
          <h1 className="text-[32px] font-extrabold tracking-tight sm:text-[40px]">Financing made simple</h1>
