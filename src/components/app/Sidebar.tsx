...
import { Settings as SettingsIcon, FileText, Users as UsersIcon, BarChart3, Plug, CreditCard } from "lucide-react";
...
const NAV: Entry[] = [
  ...
  { type: "item", href: "/dashboard/billing", label: "Billing", Icon: (p: { className?: string }) => <CreditCard className={p.className} /> },
